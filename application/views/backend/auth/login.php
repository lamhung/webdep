    ...
    <head>
        ...
        <style>
            * {
            ...
            body {
                background: url(/assets/backend/img/login_background.jpg) no-repeat center center fixed;
                ...
                <div class="col-md-4">
                    <section class="login-form">
                        <form method="post" name="login-form" id="login-form" autocomplete="off">
                            <img src="<?php echo base_url('assets/backend/img/login_image.png');?>" class="img-responsive logo" alt="" />
                            <small class="help-block pull-left" style="color: red;"><?php echo $msg; ?></small>
                            <div>
